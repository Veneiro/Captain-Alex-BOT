...
class music_cog(commands.Cog):
    ...
    def search_playlist(self, item):
        with YoutubeDL(self.YDL_OPTIONS) as ydl:
            try:
                info = ydl.extract_info(item, False)
            except Exception:
                return;
    ...
    async def play(self, ctx, *args):
        ...
        if voice_channel is None:
            ...
            await ctx.send("Searching song for query " + query)
    ...
    async def sound (self, ctx):
        ...
        if voice_channel != None:
            ...
            vc.play(discord.FFmpegPCMAudio(executable="./node_modules/ffmpeg-static/ffmpeg", source="C:<path_to_file>"))
